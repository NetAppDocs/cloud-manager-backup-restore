...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing-packages[Learn more about these capacity-based license packages].
