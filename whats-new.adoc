...
Now you can use Cloud Backup to back up SnapLock Enterprise volumes to the public and private cloud. This feature requires that your ONTAP system is running ONTAP 9.11.1 or later.

=== On-premises Connector is now supported when creating backup files in the public cloud

In the past you needed to deploy the Connector in the same cloud provider as where you were creating backup files. Now you can use a Connector deployed in your premises to create backup files in Amazon S3, Azure Blob, and Google Cloud storage.
