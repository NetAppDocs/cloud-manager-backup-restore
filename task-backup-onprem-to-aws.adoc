...
+
** An HTTPS connection over port 443 to the Cloud Backup service and to your S3 object storage (see the list of endpoints link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-checklist-cm.html[here^])
