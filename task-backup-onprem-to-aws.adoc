...
[role="quick-margin-para"]
Optionally, you can set up your own custom-managed keys for data encryption instead of using the default Amazon S3 encryption keys. <<Prepare Amazon S3,See how to get your AWS S3 environment ready to receive ONTAP backups.>>
