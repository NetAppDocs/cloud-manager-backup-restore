...
[.lead]
You can restore Virtual Machines from the cloud back to the on-premises vCenter. The backup will be restored to the exact same location from where the backup was taken. You can restore VMs from the datastore or from the VMs view.

You cannot restore the backup to any other alternate location.
