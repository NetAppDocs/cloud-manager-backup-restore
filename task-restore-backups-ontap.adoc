...
Cloud Manager creates a new volume based on the backup you selected. You can link:task-managing-backups-ontap.html[manage the backup settings for this new volume^] as required.
