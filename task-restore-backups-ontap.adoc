...
| Cost associated with Cloud Restore instance when browsing backups for individual files | Cost associated with Amazon Athena and AWS Glue resources when scanning your backups and volumes for search results
