...
| Browse through a folder-style structure to find the volume or file (you must know where the data resides) | Search for a volume or file across *all backup files* by partial or full volume name, partial or full file name, size range, and additional search filters
