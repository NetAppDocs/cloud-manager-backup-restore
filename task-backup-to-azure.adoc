...
See link:task-deploying-otc-azure.html[Launching Cloud Volumes ONTAP in Azure] for requirements and details for creating your Cloud Volumes ONTAP system.
